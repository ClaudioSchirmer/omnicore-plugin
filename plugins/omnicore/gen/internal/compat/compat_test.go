...
func TestVerdicts(t *testing.T) {
	...
	cases := []struct {
		...
		{"the supported line", "v0.52.0", false, Exact, false},
		{"same line, later patch", "v0.52.9", false, Exact, false},
		{"framework moved ahead", "v0.53.0", false, Ahead, false},
		{"project is one line older", "v0.51.9", false, Behind, true},
