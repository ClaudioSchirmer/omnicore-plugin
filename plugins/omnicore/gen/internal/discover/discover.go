...
// ("Code generated by omnicore-gen. DO NOT EDIT.") AND the emitter's own doc
// line ("Code generated by omnicore-gen from the X spec"), and matching further
// into either would depend on which of the two a given emitter happens to
// write.
