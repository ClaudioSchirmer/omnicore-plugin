...
source a generator can have: today that is the framework's **v0.54.0**, paired with plugin
**0.23.0**. Publish the two in sync. An older pin is refused by default with the fix named;
